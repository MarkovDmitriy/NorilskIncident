...
UCLASS(Abstract)
class NORILSKDEMO_API ABaseCharacter : public ACharacter
{
...
public:
	...
	*/
	class ABaseWeapon* GetInventoryWeapon(int32 index) const;

	/** get weapon taget modifier speed	*/
	UFUNCTION(BlueprintCallable, Category = "Game|Weapon")
	float GetTargetingSpeedModifier() const;

	UFUNCTION(BlueprintPure, Category = "Game|Behavior")
	EGameFractions GetFraction() const;
